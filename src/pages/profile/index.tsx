        ...
        <div className="flex items-center mt-4 space-x-3">
          ...
          <div className="flex flex-col">
            ...
            <Link href="/profile/edit">
              <button className="text-sm text-gray-700">Edit profile &rarr;</button>
            </Link>
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="mt-4 text-gray-600 text-sm">
            <p>
              ...
              don&apos;t belong to me. Besides, I&apos;ve already been through too much shit this morning over this case to hand
